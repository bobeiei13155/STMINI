  ...
  <div class="container-fluid">
    <header>
      <form action="/Stminishow/SearchPromotionPay" method="GET" enctype="multipart/form-data">
        <div class="row">
          <div class="col">
            <h1 class="h1">ข้อมูลโปรโมชั่นยอดชำระ</h1>
          </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="row ">
          <div class="col">
            <a class="btn btn-primary" href="/Stminishow/createPromotionPay"><i class="fas fa-plus" style="margin-right: 5px;"></i> เพิ่มโปรโมชั่นยอดชำระ</a>
          </div>
          <div class="col">
