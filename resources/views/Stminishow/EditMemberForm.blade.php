        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/Stminishow/updateMember/{{$members->Id_Member}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="date" class="form-control" name="Bdate_Member" id="Bdate_Member" value="{{$members->Bdate_Member}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="submit" id="submit" class="btn btn-success"> <i class="fas fa-plus" style="margin-right: 5px;"></i>แก้ไข</button>
